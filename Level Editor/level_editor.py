...
def draw_bg():
    ...
    for x in range(4):
        ...
        screen.blit(mountain_img, ((x * width) - scroll * 0.6, SCREEN_HEIGHT - mountain_img.get_height() - 270))
        screen.blit(pine1_img, ((x * width) - scroll * 0.8, SCREEN_HEIGHT - pine1_img.get_height() - 135))
...
exit_button = button.Button(SCREEN_WIDTH // 2 + 200, SCREEN_HEIGHT + LOWER_MARGIN - 50, exit_img, 1)
# make a button list
button_list = []
button_col = 0
button_row = 0
...
while run:
    ...
    # check that the coordinates are within th tile area
